...
struct thread
{
    ...
    /* mlfqs parameters of the thread :nice &recent_CPU_time*/
    int mlfqs_nice;                      /*mlfqs niceness value*/
    int mlfqs_recent_CPU;                /* mlfqs recent_CPU time */
...
//-----------------------------------------------------------
/* mlfqs methods */
int mlfqs_priority_calc(const struct thread *t);
void mlfqs_recent_CPU_calc(struct thread *t, void *aux UNUSED);
int mlfqs_load_avg_calc(void);
int mlfqs_ready_count();
void mlfqs_list_sort(void);
